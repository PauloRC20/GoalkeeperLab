...
lfilterrate = uicontrol(f,'Style','text','String', 'Adv. Options: '); lfilterrate.Position = [605 345 200 20]; lfilterrate.BackgroundColor = [1 1 1]; uicontrol(lfilterrate);
filterrate = uicontrol(f,'Style','radiobutton','String','Option 1','String', 'Apply'); filterrate.Position = [650 325 100 20]; filterrate.BackgroundColor = [1 1 1]; filterrate.Tag = 'filter';

lposit = uicontrol(f,'Style','text','String', 'Previous Guess: '); lposit.Position = [850 345 200 20]; lposit.BackgroundColor = [1 1 1];uicontrol(lposit);
posit = uicontrol(f,'Style','edit'); posit.Position = [930 325 40 20]; posit.Tag = 'position';

conditioning = uicontrol(f,'Style','popupmenu','String',{'-','CORRECT','INCORRECT'}); conditioning.Position = [1100 325 150 20]; conditioning.Tag = 'condition';
